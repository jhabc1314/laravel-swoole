...
return [
    ...
    'server' => [
        ...
        'host' => '127.0.0.1',
        'port' => '8821',
        'serialize_type' => 1, //1serialize 2 json
        'setting' => [
            ...
            'log_file' => __DIR__ . '/../../swoole.log',//storage_path('log/swoole.log'), //swoole运行日志的保存位置
            'pid_file' => __DIR__ . '/../../server.pid',//storage_path('log/server.pid'), //pid保存的文件

            //'tcp_defer_accept' => false, //tcp延迟收包时间
