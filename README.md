...
- 配置
    ...
    - 如果使用 `management` 管理后台，需要将服务发现方式改为 `2`(推荐)
- 启动服务
     - `php artisan swoole:server server_name start/stop/reload` //开启、关闭、热重启 server_name 服务
...
- 迭代计划
    ...
    - 支持基础 `web socket` 功能
    - 服务节点检测，自动下线服务 已实现 [了解详情](https://github.com/jhabc1314/management/releases/tag/0.2.4)
